...
class _ActivityApp extends Component {
    ...
    render() {
        ...
        if (!activities) return <div className="loader"><img src={'https://res.cloudinary.com/dojmo7vcc/image/upload/v1602514420/health_events/loader_lsslis.gif'} alt=""/></div>
        return (
            <div>
                <ActivityFilter onSetFilter={this.onSetFilter} dummySortByDays={this.dummySortByDays} />

                <div className="main-container-activities mt50">
