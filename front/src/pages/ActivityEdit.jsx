...
class _ActivityEdit extends Component {
    ...
    render() {
        ...
        if (!Object.keys(activity).length) return <div className="loader"><img src={'https://res.cloudinary.com/dojmo7vcc/image/upload/v1602514420/health_events/loader_lsslis.gif'} alt="" /></div>
        return (
